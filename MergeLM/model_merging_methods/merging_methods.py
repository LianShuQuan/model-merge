...
from utils.utils import get_param_names_to_merge, get_modules_to_merge, get_param_names_to_merge_match
...
class MergingMethod:
    ...
    def average_merging(self, models_to_merge: list, exclude_param_names_regex: list, include_param_names_regex: list=None, layers_to_merge: list=None):
        """
        ...
        for model_to_merge in models_to_merge:
            ...
            # include parameter whose name matches element in include_param_names_regex
            if include_param_names_regex is not None:
                param_names_to_merge = get_param_names_to_merge_match(input_param_names=list(param_dict.keys()), include_param_names_regex=include_param_names_regex)
        ...
        with torch.no_grad():
            ...
            for param_name, model_to_merge_param in models_to_merge_param_dict.items():
                logging.info(f"average_merging  param_name_to_merge: {param_name}")
    ...
    def task_arithmetic(self, merged_model: nn.Module, models_to_merge: list, exclude_param_names_regex: list, include_param_names_regex: list=None, scaling_coefficient: float = 1.0):
        """
        ...
        models_to_merge_task_vectors = [TaskVector(pretrained_model=merged_model, finetuned_model=model_to_merge, exclude_param_names_regex=exclude_param_names_regex, include_param_names_regex=include_param_names_regex) for model_to_merge in models_to_merge]
    ...
    def fisher_merging(self, models_to_merge: list, trainers: list, exclude_param_names_regex: list, nums_fisher_examples: list, fisher_scaling_coefficients: list = None,
                       normalize_fisher_weight: bool = True, minimal_fisher_weight: float = 1e-6, include_param_names_regex: list=None):
        """
    ...
    def regmean_merging(self, models_to_merge: list, trainers: list, exclude_param_names_regex: list, nums_regmean_examples: list, reduce_non_diagonal_ratio: float = 1.0, include_param_names_regex: list=None):
        """
    ...
    def ties_merging(self, merged_model: nn.Module, models_to_merge: list, exclude_param_names_regex: list, param_value_mask_rate: float = 0.8, scaling_coefficient: float = 1.0, include_param_names_regex: list=None):
        """
        ties merging method
        :param merged_model: nn.Module, the merged model
        :param models_to_merge: list, individual models that need to be merged
    ...
    def merging_models(self, merged_model: nn.Module, models_to_merge: list, exclude_param_names_regex: list, include_param_names_regex: list=None, trainers: list = None, scaling_coefficient: float = 1.0,
                       ...
                       mask_apply_method: str = "average_merging", models_use_deepcopy: bool = False, layers_to_merge: list = None):
        """
        ...
        if self.merging_method_name == "average_merging":
            merged_params = self.average_merging(models_to_merge=models_to_merge, exclude_param_names_regex=exclude_param_names_regex, include_param_names_regex=include_param_names_regex)
                ...
                for new_model_to_merge, weight_mask_rate in zip(new_models_to_merge, weight_mask_rates):
                    ...
                    masked_param_dict = mask_model_weights(finetuned_model=new_model_to_merge, pretrained_model=merged_model,
                                                           exclude_param_names_regex=exclude_param_names_regex,
                                                            include_param_names_regex=include_param_names_regex, weight_format=weight_format,
            ...
            if mask_apply_method == "average_merging":
                merged_params = self.average_merging(models_to_merge=new_models_to_merge, exclude_param_names_regex=exclude_param_names_regex, include_param_names_regex=include_param_names_regex)
    ...
    def get_merged_model(self, merged_model: nn.Module, models_to_merge: list, exclude_param_names_regex: list, include_param_names_regex: list=None, trainers: list = None, scaling_coefficient: float = 1.0,
                         nums_fisher_examples: list = None, fisher_scaling_coefficients: list = None, normalize_fisher_weight: bool = True, minimal_fisher_weight: float = 1e-6,
                         nums_regmean_examples: list = None, reduce_non_diagonal_ratio: float = 1.0, param_value_mask_rate: float = 0.8,
                         weight_format: str = "delta_weight", weight_mask_rates: list = None, use_weight_rescale: bool = True, mask_strategy: str = "random",
                         mask_apply_method: str = "average_merging", models_use_deepcopy: bool = False, layers_to_merge = None):
        """
        ...
        merged_params = self.merging_models(merged_model=merged_model, models_to_merge=models_to_merge, exclude_param_names_regex=exclude_param_names_regex, include_param_names_regex=include_param_names_regex, trainers=trainers,
                                            ...
                                            mask_apply_method=mask_apply_method, models_use_deepcopy=models_use_deepcopy, layers_to_merge=layers_to_merge)
