...
if __name__ == "__main__":
    model_dataset_to_merge = ["cola", "sst2", "mrpc", "stsb", "qqp", "mnli", "qnli", "rte"]
    for source_dataset_name in model_dataset_to_merge:
        for target_dataset_name in model_dataset_to_merge:
