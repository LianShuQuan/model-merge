...
parser.add_argument("--models", help="Models to Merge",
                    choices=["math_code", "LM_math", "LM_code", "LM_math_code", "LM", "math", "code", "Coder"])
...
parser.add_argument("--window_size", default=0, type=float,
                    help="Window Size for Probabilities. Set to 0 for TIES and DARE")
...
# Base model paths
CODELLAMA_PATH = "codellama/CodeLlama-13b-hf"
LLAMA2_13B_PATH = "NousResearch/Llama-2-13b-hf"
